<script lang="ts">
    ...
    const openGenerator = async () => {
        await open("https://id.twitch.tv/oauth2/authorize?client_id=" + client_id + "&redirect_uri=http://localhost:7777/twitch&response_type=token&scope=moderator:manage:banned_users")
    }
</script>
